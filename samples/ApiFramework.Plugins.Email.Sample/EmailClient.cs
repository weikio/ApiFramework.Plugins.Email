...
namespace MyNamespace
{
    ...
    public partial class EmailSenderClient 
    {
        ...
        public EmailSenderClient(System.Net.Http.HttpClient httpClient)
        {
        ...
        public System.Threading.Tasks.Task<bool> CreateAsync(Email email)
        {
            return CreateAsync(email, System.Threading.CancellationToken.None);
        }
    
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<bool> CreateAsync(Email email, System.Threading.CancellationToken cancellationToken)
        {
            if (email == null)
                throw new System.ArgumentNullException("email");
    
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/email");
    ...
    public partial class Email 
    {
        ...
        public System.Collections.Generic.ICollection<EmailAttachment> Attachments { get; set; }
